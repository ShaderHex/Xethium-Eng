...
namespace XENGINE {
    ...
    // Game Object
    XAPI GameObject::GameObject CreateCube(float x, float y, float z, float rotX, float rotY, float rotZ, float scaleX, float scaleY, float scaleZ, Color color, const char* texturePath);
